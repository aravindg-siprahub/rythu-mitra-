...
const variants = {
  primary:
    "bg-[var(--accent-blue)] text-white shadow-lg shadow-blue-500/20 hover:shadow-blue-500/40 border border-transparent",
  secondary:
    "bg-slate-800 text-white border border-slate-700 hover:bg-slate-700 hover:border-slate-600",
  outline:
    "bg-transparent text-[var(--accent-blue)] border border-[var(--accent-blue)] hover:bg-blue-500/10",
  ghost: "bg-transparent text-slate-400 hover:text-white hover:bg-slate-800/50",
  gradient:
    "bg-gradient-to-r from-blue-600 to-violet-600 text-white shadow-lg hover:shadow-violet-500/25 border-none",
  danger:
