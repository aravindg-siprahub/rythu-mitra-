...
# ─── CELERY ───────────────────────────────────────────────────────────────────
CELERY_BROKER_URL = env('CELERY_BROKER_URL') or env('REDIS_URL') or 'redis://localhost:6379/0'
CELERY_RESULT_BACKEND = env('CELERY_RESULT_BACKEND') or env('REDIS_URL') or 'redis://localhost:6379/1'
